...
#We're using 'float()' to make sure our numbers can have decimals too. cool, right ?
...
# Step 3: Time to do some math! Lets compute the sum, difference, product, and quotient.

# Add two numbers  ( Yay! Addition is the first step to fun!)
